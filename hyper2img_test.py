...
with torch.no_grad():
    for i in range(len(testdata)):
        ...
        output_path = img_path.replace('/home/uchihawdt/DehazeFormer/data/D-HAZY/test/hazy/', '/home/chenzhiqiang1/code/control-net-main-wdt/output/czqdehaze/')     #f'{output_dir}/{i}.png'   
        ...
        if not os.path.exists(output_path):
            samples, intermediates = ddim_sampler.sample(ddim_steps, num_samples,
                                                            ...
                                                            hyper_scale=hyper_scale, is_train=False) # control_scale=control_scale, multi=True)
